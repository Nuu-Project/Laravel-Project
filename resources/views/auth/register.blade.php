...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-900" for="name" :value="__('Name')">Name</lable>
            <input id="name" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" type="text" name="name" :value="old('name')" required autofocus autocomplete="name"></input>
        ...
        <div class="mt-4">
            ...
            <input id="password" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" type="password" name="password" required autocomplete="new-password"> </input>
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <label class="block mb-2 text-sm font-medium text-gray-900" for="password_confirmation" :value="__('Confirm Password')">Confirm Password</lable>

            <input id="password_confirmation" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            type="password"
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline-none text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
