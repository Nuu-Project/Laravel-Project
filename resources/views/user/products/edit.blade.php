                ...
                <form id="productForm" class="grid gap-6"
                    ...
                    <x-div.grid>
                        ...
                        <x-select.form id="semester" name="semester">
                            <option value="" disabled @if (empty($product->semester)) selected @endif>選擇學期...</option>
                            @foreach ($tags as $tag)
                    ...
                    <x-div.grid>
                        ...
                        <x-select.form id="subject" name="subject">
                            <option value="" disabled @if (empty($product->subject)) selected @endif>選擇科目...</option>
                            @foreach ($tags as $tag)
                    ...
                    <x-div.grid>
                        ...
                        <x-select.form id="category" name="category">
                            <option value="" disabled @if (empty($product->category)) selected @endif>選擇課程類別...</option>
                            @foreach ($tags as $tag)
                            ...
                            @for ($i = 0; $i < 5; $i++)
                                <div class="relative h-[192px]" x-data="imageUploader{{ $i }}">
                                    ...
                                    <button type="button"
                                        ...
                                        id="deleteButton{{ $i }}"
                                        x-show="hasExistingImage || success"
                                        x-transition:enter="transition ease-out duration-300"
